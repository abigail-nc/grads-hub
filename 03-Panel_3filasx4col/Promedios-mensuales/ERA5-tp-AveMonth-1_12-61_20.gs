*Script para plotear promedios mensuales de prcp de enero a diciembre en el periodo 61-20 <60 años>
'reinit'

*Abrir archivo
'sdfopen ../../../DATOS/DATOS-CORREGIDOS/PROMEDIOS/ERA5-tp-61_20-CLM.nc'

*Ajustar el despliegue de los datos
...
'../colormaps_v2.gs -map Terrain1 -flipped -levels 0 300 5'
'd tp(t=01)'
*FEBRERO
...
etiquetas()
'printim ../../../FIGURAS/Clima-Anual/clim-prcpPROM-61_20_V2.png x2200 y1700'
